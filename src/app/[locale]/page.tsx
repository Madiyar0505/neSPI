  ...
  return (
    <div className="w-full">
      ...
      <section className="w-full flex flex-col items-center">
        <div className="relative w-full max-w-5xl mx-auto flex flex-col md:flex-row rounded-2xl overflow-hidden mt-8 bg-transparent" style={{minHeight: 380}}>
          {/* Left: Text + brown bg */}
        ...
        {/* Cards */}
        <div className="w-full max-w-5xl mx-auto flex flex-col md:flex-row gap-6 mt-[-40px] z-20 relative">
      ...
      <section className="w-full flex flex-col items-center mt-16">
        {/* Stats row */}
        <div className="w-full max-w-5xl mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-4 md:gap-8 mb-8">
        ...
        {/* Info block */}
        <div className="w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 items-stretch rounded-2xl overflow-hidden bg-transparent min-h-[220px] md:min-h-[340px]">
          {/* Left: Text + brown bg */}
      ...
      <div className="w-full mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="relative rounded-2xl overflow-hidden min-h-[140px] md:min-h-[180px] flex items-end group" style={{background: 'url(/military-bg.jpg) center/cover, #58513a'}}>
          ...
          <div className="relative rounded-2xl overflow-hidden min-h-[140px] md:min-h-[180px] flex items-end group" style={{background: 'url(/family-bg.jpg) center/cover, #58513a'}}>
            <div className="absolute inset-0 bg-[#58513a]/80 group-hover:bg-[#58513a]/90 transition-all"></div>
            <div className="relative z-10 p-8 w-full flex items-center justify-start">
        ...
        {/* Sections block */}
        <div className="w-full md:rounded-2xl rounded-xl overflow-hidden">
          <div className="bg-[#58513a] w-full p-8 md:p-12">
